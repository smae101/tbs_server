    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, blank=True, to='tbs.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('notification_expiration', models.DateTimeField(default=tbs.models.Notification.expiration)),
