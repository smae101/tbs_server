...
router.register(r'available_items_to_sell', serializers.AvailableItemsToSellViewSet)
router.register(r'available_items_for_rent', serializers.AvailableItemsForRentViewSet)
...
router.register(r'reserved_items_for_donation', serializers.ReservedItemsForDonationViewSet)
